...
describe("summarizeMonthlyRewards", () => {
  const transactions = [
    ...
    { id: "T2", customerId: "C001", customer: "Alice", amount: 80, date: "2025-04-20" },
    { id: "T3", customerId: "C002", customer: "Bob", amount: 50, date: "2025-05-01" },
    { id: "T4", customerId: "C002", customer: "Bob", amount: 200, date: "2025-05-15" },
    { id: "T5", customerId: "C003", customer: "Charlie", amount: -100, date: "2025-05-20" }
  ];
  ...
  test("groups and sums correctly by customer, month and year", () => {
    ...
    expect(summary).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ customerId: "C001", month: "April", year: 2025, points: 120 }),
        expect.objectContaining({ customerId: "C002", month: "May", year: 2025, points: 250 }),
